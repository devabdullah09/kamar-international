          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-gray-300">
              <li className="flex items-start">
                ...
                <span className="text-xs sm:text-sm">123 Business Street<br />City, Country 12345</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-xs sm:text-sm break-all">info@kamarinternational.com</span>
              </li>
            </ul>
          </div>
        </div>
